...
Level2::Level2(int color) : Computer(color, 2) {}

void Level2::computerMove(Board* board, TextDisplay* td, GraphDisplay* gd) {
    ...
    // Prefer capturing moves, then checking moves, and lastly other moves
